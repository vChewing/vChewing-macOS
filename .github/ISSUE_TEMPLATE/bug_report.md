...
### **請在開新的工單之前閱讀《[故障提報與用儀器捉蟲](https://vchewing.github.io/BUGREPORT.html)》按照裡面的方法整理相關資訊、且在開工單之後電郵知會我。因各種可能原因，唯音輸入法的主程式師可能無法隨時收取 GitHub 與 Gitee 的工單提醒訊息。**
...
所以呢，這個問題也請答覆。但如果是唯音輸入法特有功能出現故障的話，那這個問題可以不用答覆。
...
**其他**
其他你覺得問題發生的疑點，或其他你想跟唯音輸入法開發團隊說的話。
