...
唯音輸入法保留拒絕任何種類的功能建議的權利（本來就有）。

閱讀來自各位使用者的功能建議請求，是一回事；**但**唯音輸入法研發方怎樣利用這些建議請求背後的潛在資訊、來制定唯音輸入法接下來的研發方向（或可能棄用相關想法），則是**另一回事**。

**痛點**
請告訴我們為什麼目前唯音輸入法沒辦法解決您的問題。您可以講一個能讓讀者得以感同身受的小故事，比如：

- 我從 xx 年前開始，使用了 xx 輸入法，我相當依賴其中一項功能，但是唯音輸入法沒有...
