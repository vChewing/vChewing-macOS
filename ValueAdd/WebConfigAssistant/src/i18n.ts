...
namespace VCA {
  ...
  export var UI_STRINGS: { [lang: string]: UIStringTable } = {
    "zh-Hant": {
      ...
      // 步驟標題與導言
      "step.background.title": "您原本用哪一款輸入法？",
      "step.background.intro": "這會決定助手接下來問您哪些問題——每一家輸入法的習慣不同，唯音有對應的設定。",
      ...
      "origin.opt.pinyin": "搜狗／紫光等漢語拼音輸入法",
      "origin.opt.newbie": "我是全新使用者",

      // 自訂題目：打字方式
      "typing.title": "您主要用哪一種打字方式？",
      "typing.intro": "這只影響助手之後問您哪些問題，本身不會寫入任何設定。",
    ...
    "zh-Hans": {
      ...
      // 步骤标题与导言
      "step.background.title": "您原本用哪一款输入法？",
      "step.background.intro": "这会决定助手接下来问您哪些问题——每一家输入法的习惯不同，唯音有对应的设定。",
      "step.method.title": "打字方式",
      ...
      "origin.opt.pinyin": "搜狗／紫光等汉语拼音输入法",
      "origin.opt.newbie": "我是全新使用者",

      // 自订题目：打字方式
      "typing.title": "您主要用哪一种打字方式？",
      "typing.intro": "这只影响助手之后问您哪些问题，本身不会写入任何设定。",
    ...
    en: {
      ...
      "step.background.title": "Which input method did you use before?",
      "step.background.intro": "This decides which questions come next — every input method has its own habits, and vChewing has matching preferences for each.",
      ...
      "origin.opt.pinyin": "Mainland Pinyin IMEs (Sogou, Ziguang, …)",
      "origin.opt.newbie": "I am a brand-new user",

      // Custom question: typing method
      "typing.title": "How do you mainly type?",
      "typing.intro": "This only decides which questions come next; it never writes any preference by itself.",
      ...
      "typing.opt.scpc": "Zhuyin per-character selection (\"Bopomofo half\")",
    ...
    ja: {
      ...
      // ステップの表題と導入
      "step.background.title": "以前はどの入力方法をお使いでしたか？",
      "step.background.intro": "これにより、以降に尋ねる項目が決まります。入力方法ごとに習慣が異なり、唯音にはそれぞれに対応する設定があります。",
      ...
      "origin.opt.pinyin": "漢語弁音系（捜狗・紫光など）",
      "origin.opt.newbie": "まったくの初心者です",

      // 独自の設問：入力方法
      "typing.title": "主にどの方法で入力しますか？",
      "typing.intro": "これは以降に尋ねる項目を決めるだけで、それ自体は何も書き込みません。",
