...
// 本檔為 SwiftUI 專屬（`UserDefRenderable` 的 SwiftUI 側實作；該型別於 `Shared_DarwinImpl` 內亦為 6.2+ 專屬），
// legacy 倉庫無對位模組可繼承；依「SwiftUI 之任何內容不得裸露於 5.10 可編的路徑上」整段圈進 compiler
// condition，<6.2 分支不提供替代實作。
#if compiler(>=6.2)
