...
//   動態庫，既有跨平台產物結構不變。
//
// 註一：SwiftPM 對本地路徑相依的 package identity **取自目錄名**。本套件的目錄名、
// package identity 與本 manifest 的 `name:` 三者同為 `VanguardSwiftExtension`，故各消費端
// 一律宣告 `package: "VanguardSwiftExtension"`。
