...
extension POMTestSuite {
  ...
  final class POMRapidForgetTests {
    ...
    /// 測試 LXFacade 對 POM 的 rapid-forget 注入轉發。
    @Test
    func testPOM_RapidForget_03_LXFacadeForwardsReducedLifetimeFlag() throws {
      let instance = LXAssembly.LXFacade(pomDataURL: nullURL)
