...
// **本檔是封堵檔（blocker），不是建置設定檔。** 內容與理由同 `Package@swift-6.2.swift`（6.2／6.3 兩版
// 同屬「災星」，皆因 `#ConformanceIsolation` 而無法編譯本聚合體）。之所以仍各寫一份，是因為
// SwiftPM 之比對基準是**檔內宣告的 tools version**，6.3 toolchain 只會挑到 tools version 6.3 這一檔。
#error(
  """
