...
// requirements defined in MIT License.
  ...
  extension NSColor {
    public var asHSBA: HSBA {
      .init(
        hue: redComponent,
        saturation: greenComponent,
        brightness: blueComponent,
  ...
  extension HSBA {
    ...
    public var nsColor: NSColor {
      let r = hue.isFinite ? max(0, min(1, hue)) : 0
      let g = saturation.isFinite ? max(0, min(1, saturation)) : 0
    ...
    public init(_ nsColor: NSColor) {
      self.init(
        hue: nsColor.redComponent,
        saturation: nsColor.greenComponent,
        brightness: nsColor.blueComponent,
