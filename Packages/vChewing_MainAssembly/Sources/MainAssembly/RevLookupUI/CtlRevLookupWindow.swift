...
final class FrmRevLookupWindow: NSWindow {
  ...
  func keyboardConfirmed(_: Any?) {
    ...
    resultView.string = "\n" + "i18n:Loading.Ellipsis".localized
  ...
  private func setupUI() {
    ...
    title = "i18n:Menu.ReverseLookupPhonabets".localized
    ...
    resultView.string = "i18n:Settings.Validation.maximum15ResultsReturnable".localized
    ...
    inputField.toolTip =
      "i18n:Settings.Validation.maximum15ResultsReturnable".localized
  }
  ...
  private func updateResult(with input: String) {
    ...
    strBuilder.append("\n")
    strBuilder.append("i18n:UI.Label.charReadingS".localized)
    strBuilder.append("==\t====\n")
    var i = 0
    theLoop: for char in input.map(\.description) {
      if i == 15 {
        strBuilder.append("i18n:Settings.Validation.maximum15ResultsReturnable".localized + "\n")
        break theLoop
      }
