...
public class PopupCompositionBuffer: NSWindowController {
  ...
  public init() {
    ...
    NSLayoutConstraint.activate([
      compositionView.topAnchor.constraint(equalTo: containerView.topAnchor),
      compositionView.leadingAnchor.constraint(equalTo: containerView.leadingAnchor),
      compositionView.trailingAnchor.constraint(equalTo: containerView.trailingAnchor),
      compositionView.bottomAnchor.constraint(equalTo: containerView.bottomAnchor),
    ])
