...
/// 唯音輸入法的 InputHandler 單元測試（OSNeutralAssembly 模組）
...
final class InputHandlerTests {
  ...
  init() throws {
    ...
    UserDefaults.unitTests = .init(suiteName: "org.atelierInmu.vChewing.OSNeutralAssembly.UnitTests")
  ...
  deinit {
    ...
    UserDefaults.unitTests?.removeSuite(named: "org.atelierInmu.vChewing.OSNeutralAssembly.UnitTests")
    UserDef.resetAll()
  }
