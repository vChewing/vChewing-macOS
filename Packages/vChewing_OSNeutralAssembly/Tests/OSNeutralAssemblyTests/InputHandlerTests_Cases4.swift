...
extension InputHandlerTests {
  ...
  /// Izanami tests for MixedAlnum OSNeutralAssembly to make sure all applausable kanji readings are inputtable.
  ///
  ...
  /// 半形標點模式開啓時，Ctrl+ASCII 組合鍵不得被 OSNeutralAssembly 攔截。
  @Test
