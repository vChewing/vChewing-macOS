...
CCConverterRef _Nonnull CCConverterCreate(const char *_Nonnull name, CCDictRef _Nonnull segmentation,
                                          CCDictRef _Nonnull *const _Nonnull conversionChain, intptr_t chainCount)
{
...
STLString _Nullable CCConverterCreateConvertedStringFromString(CCConverterRef _Nonnull converter,
