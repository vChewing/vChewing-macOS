...
class TestFactory4 : public TestFactory3
{
  public:
    ...
    TestFactory4(int v) : TestFactory3(v)
    {
...
{
  public:
    TestFactory5(int i) : TestFactory3(i)
    {
...
class PyTF6 : public TestFactory6
{
  public:
    ...
    PyTF6(PyTF6 &&f) : TestFactory6(std::move(f))
    {
        print_move_created(this);
    }
...
class PyTF7 : public TestFactory7
{
  public:
    ...
    PyTF7(PyTF7 &&f) : TestFactory7(std::move(f))
    {
        print_move_created(this);
    }
