...
class MoveOnlyInt
{
  public:
    ...
    MoveOnlyInt(int v) : value{std::move(v)}
    {
...
class MoveOrCopyInt
{
  public:
    ...
    MoveOrCopyInt(int v) : value{std::move(v)}
    {
        print_created(this, value);
    }
...
class CopyOnlyInt
{
  public:
    ...
    CopyOnlyInt(int v) : value{std::move(v)}
    {
        print_created(this, value);
    }
...
TEST_SUBMODULE(copy_move_policies, m)
{
    ...
    m.def("move_copy_nested",
          [](std::pair<MoveOnlyInt,
                       std::pair<std::tuple<MoveOrCopyInt, CopyOnlyInt, std::tuple<MoveOnlyInt>>, MoveOrCopyInt>>
                 x) {
