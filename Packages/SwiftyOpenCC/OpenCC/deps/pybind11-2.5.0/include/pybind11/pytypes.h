...
#define PYBIND11_OBJECT_CVT(Name, Parent, CheckFun, ConvertFun)                                                        \
    ...
    template <typename Policy_> Name(const ::pybind11::detail::accessor<Policy_> &a) : Name(object(a))                 \
    {                                                                                                                  \
    }
...
class int_ : public object
{
  public:
    ...
    template <typename T, detail::enable_if_t<std::is_integral<T>::value, int> = 0> operator T() const
    {
...
class slice : public object
{
  public:
    ...
    {
        return PySlice_GetIndicesEx((PYBIND11_SLICE_OBJECT *)m_ptr, (ssize_t)length, (ssize_t *)start, (ssize_t *)stop,
