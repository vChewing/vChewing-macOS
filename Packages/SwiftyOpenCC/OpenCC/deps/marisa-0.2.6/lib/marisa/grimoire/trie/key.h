...
class Key
{
  public:
    ...
    Key(const Key &entry) : ptr_(entry.ptr_), length_(entry.length_), union_(entry.union_), id_(entry.id_)
    {
    }
...
class ReverseKey
{
  public:
    ...
    ReverseKey(const ReverseKey &entry) : ptr_(entry.ptr_), length_(entry.length_), union_(entry.union_), id_(entry.id_)
    {
    }
