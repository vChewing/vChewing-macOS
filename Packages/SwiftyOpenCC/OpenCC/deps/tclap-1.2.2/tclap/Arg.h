 ...
 */
template <typename T> void ExtractValue(T &destVal, const std::string &strVal, ValueLike vl)
{
 ...
 */
template <typename T> void ExtractValue(T &destVal, const std::string &strVal, StringLike sl)
{
...
inline Arg::Arg(const std::string &flag, const std::string &name, const std::string &desc, bool req, bool valreq,
                Visitor *v)
