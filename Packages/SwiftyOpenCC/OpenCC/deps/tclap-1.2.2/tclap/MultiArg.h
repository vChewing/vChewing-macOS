...
MultiArg<T>::MultiArg(const std::string &flag, const std::string &name, const std::string &desc, bool req,
    ...
    : Arg(flag, name, desc, req, true, v), _values(std::vector<T>()), _typeDesc(typeDesc), _constraint(NULL),
      _allowMore(false)
{
...
MultiArg<T>::MultiArg(const std::string &flag, const std::string &name, const std::string &desc, bool req,
    ...
    : Arg(flag, name, desc, req, true, v), _values(std::vector<T>()), _typeDesc(constraint->shortID()),
...
template <class T> bool MultiArg<T>::processArg(int *i, std::vector<std::string> &args)
{
 ...
 *
 */
template <class T> std::string MultiArg<T>::shortID(const std::string &val) const
{
