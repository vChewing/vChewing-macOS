 ...
 */
template <class T> T &ValueArg<T>::getValue()
{
    return _value;
}
 ...
 */
template <class T> bool ValueArg<T>::processArg(int *i, std::vector<std::string> &args)
{
 ...
 */
template <class T> std::string ValueArg<T>::shortID(const std::string &val) const
{
